...
namespace GestaoFacil.infra.Data.Repository
{
    ...
    {
        //protected readonly = acesso ao contexto só quem tem herdar vai ter acesso ao contexto.
        protected readonly GestaoFacilContext Db;    //acesso ao contexto criado
        protected readonly DbSet<TEntity> DbSet;  //acesso repido as entidades

        public Repository()
        {
            Db = new GestaoFacilContext();
